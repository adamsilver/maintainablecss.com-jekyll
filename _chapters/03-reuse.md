...
This forced abstraction, over-thought and over-engineered code may result in visual and atomic classes (and mixins). We know how painful they can be because we discussed them thoroughly in [semantics](/chapters/semantics/).
